...
LARKENHEATH DESIGN REVIEW COMMITTEE (LDRC) ARCHITECTURAL CONTROL COI¥IMITTEE (ACC) means and refers to three or more members of the Association appointed by the Board of Directors.
...
##### Definitions
COLOR -- The color scheme of a proposed alteration, if major, must be identical to the existing structure.
...
TIMING -- The proposed alteration must be completed within receipt of application approval unless otherwise stated in the LDRC approval acknowledgement.
...
These Standards address the most likely expected exterior alterations, and are not intended to be all inclusive.
...
Although  homeowners must comply fully with the Standards when implementing these alterations, no Exterior Alteration Application is required.
    ...
    - AUTHORIZED ALTERATION shall mean and refer to those exterior alterations that conform to the criteria as stated in the various sections of this document.
	  ...
	  If the change is deemed non-compliant by the LDRC, the homeowners must make appropriate changes to bring the alteration into compliance, up to and including removal of the alteration in  question.  All expenses are to be borne by the homeowner.  Alterations not designated herein, as "Authorized Alterations" and alterations not specifically addressed in the Standards are designated as "Application Required."
...
The following considerations apply:
    ...
    - Proposed alterations must be completed within 1 year of receipt of application approval.
...
Property owners will be notified in writing within 10 business days of the Architectural Control Committee LDRC decision regarding an Exterior Alteration Applicafion.
...
The appeals committee will meet and file a  written determination of the matter and serve copies on both the Violations Committee and the aggrieved person. In no case shall the appeals committee’s finding be binding on either party; however the Violations Committee may elect to review its decision in light of the finding of the appeals committee.
...
In accordance with FCC Rule 47 CFR Part 1, Subpart S, Section 1.4000 regarding the installation, maintenance and use of direct broadcast satellite, television broadcast, multipoint distribution service and customer end fixed wireless signal antennas, the Larkenheath Homeowners association's goal is to enable property owner and residents to obtain the best possible signal reception while keeping the antennas as unobtrusive as possible.
...
Property owners must submit an Exterior Alteration Application and obtain LDRC ACC approval prior to installation of storm, screen or combination doors. Requests for storm and screen doors must conform to the following criteria:
    ...
    - Storm and screen doors will be straight forward in design without ornamentation such as scallops, scrolls, imitation gate hinges (such as those on Crossbuck doors).
...
Permanent flag poles must be approved by the LDRC ACC.
    ...
    - Flags must be U.S. or U.S. Military Branch i.e. Army, Navy etc.
    - Flags must be no larger than 24" x 36" in size.
    - Flags must be of good material and w e  l  l  maintained
...
Property owners must submit an Exterior Alteration Application and obtain LDRC ACC approval prior to installation, replacement or relocation of a permanent Generator Backup Unit.
    ...
    - Permanent Generators wlll must be located in rear  yards.
...
Landscape edging must conform to the following criteria:
    ...
    - The following materials are NOT PERMITTED for use as landscape  borders  or edging: cinder blocks, railroad cross-ties and plastics that extend more than 1 inch above ground level.
...
When embarking on landscaping projects, please consider the following:
    ...
    - All trees planted become the owner responsibility to maintain.
...
Lighting that conforms to the following criteria is Approved:
    ...
    - Low voltage landscape lighting less than eighteen (18) inches  in  height - minimum distance 3 feet between lights on one (1) side.
...
Decor.
    ...
    - Security lighting or flood lights attached to the exterior of the villa this include those activated with motion sensors.
...
##### Mailboxes/Post
    ...
    - Mailboxes cannot be permanently covered.(What does this mean?)
...
##### Recreation. Sport & Plav Equipment

Basketball Equipment; Play Sels/Swing sets; Sport Practice Cages; Trampolines are not permitted.
...
APPLICATION FOR APPROVAL  REQUIRED.
Property  owners  must  submit  an Exterior Alteration Application and obtain LDRCACC approval prior to installation of replacement windows that are of a different size, style or color to those currently installed.
...
APPLICATION FOR APPROVAL REQUIRED.
Property owners must submit an Exterior Alteration Application and obtain LDRC ACC approval prior to installation of any permanent exterior decorative objects taller than thirtysix (36) inches.
...
Properties or property owners not meeting these standards may be cited for violations.
    ...
    - Hoses and related items should be properly stowed to minimize visual impact when not in use.
    ...
    - Trash cans or bags (to include yard debris) must be properly secured. Trash cans or bags (to include yard debris) and recycle bins shall be stored  out  of  site  and public view. Trash cans or bags (to include yard debris) and recycle bins (bags) must be placed curbside not earlier than 6:00 PM the night before the scheduled pick-up day. Trash cans and recycle bins (bags) must be removed from curbside not later than 8.00 PM the evening of the scheduled pick-up day.
    ...
    - Entrance gates for cars are for cars only. Do not open the car gates by hand.