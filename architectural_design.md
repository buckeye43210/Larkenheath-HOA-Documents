...
Properties or property owners not meeting these standards may be cited for violations.
    ...
    - Trash cans or bags (to include yard debris) must be properly secured. Trash cans or bags (to include yard debris) and recycle bins shall be stored out of sight and public view.
	  Trash cans or bags (to include yard debris) and recycle bins (bags) must be placed curbside not earlier than 6:00 p.m. the night before the scheduled pick-up day.
	  Trash cans and recycle bins (bags) must be removed from curbside not later than 8.00 p.m. the evening of the scheduled pick-up day.
